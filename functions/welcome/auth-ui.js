...
<head>
  ...
  <title>WSM Security - Credential Management</title>
  <style>
    * {
      margin: 0;
      padding: 0;
  ...
  <div class="container">
    ...
    <div class="features">
      <ul>
        ...
        <li>Supports multiple credential types</li>
        <li>Secure API endpoints</li>
      </ul>
    </div>

    <button class="btn-login" onclick="loginWithCatalyst()">
      Sign In with Catalyst
    </button>

    <div class="info">
      <p>This app uses Catalyst for secure authentication</p>
    </div>
  </div>

  <script>
    function loginWithCatalyst() {
      // Catalyst redirects automatically when accessing protected endpoint

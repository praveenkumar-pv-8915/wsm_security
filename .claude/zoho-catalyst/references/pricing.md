...
### Backend — File Store (deprecated, EOL April 30, 2026)
...
Use the same pricing as File Store for estimates (Stratus pricing follows similar structure):
| Operation | Unit Price (USD) | Unit |
|---|---|---|
| Upload | 0.000005 | per request |
| Download | 0.0000004 | per request |
...
Use the `references/industry-equivalents.md` to translate if they describe needs in AWS/GCP terms.

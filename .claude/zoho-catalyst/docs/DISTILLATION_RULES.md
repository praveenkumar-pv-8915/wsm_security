...
This file has moved to `skills/zoho-catalyst/DISTILLATION_RULES.md`.

This copy is intentionally left as a stub — the mounted filesystem does not permit deletion. Do not treat this as a runtime reference node.
